"""
Plot the original matplotlib Hot colormap: RGBA values and color patches.
Run: python plot_hot_colormap_info.py
Output: hot_colormap_info.png
"""
import numpy as np
import matplotlib
...
def main():
    ...
    ax.text(5, top + 0.25, 'Original Hot (index 0–255)', ha='center', fontsize=11, fontweight='bold')
    ...
    ax.set_title('Matplotlib Hot colormap – sample entries with color', fontsize=12, pad=12)
    plt.tight_layout()
    out_path = 'hot_colormap_info.png'
